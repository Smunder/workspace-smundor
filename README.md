# com-chilipeppr-workspace-smundor1
A ChiliPeppr Workspace smundor1.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / smundor1
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-smundor1 |
| Name                  | Workspace / smundor1 |
| Description           | A ChiliPeppr Workspace smundor1. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/Smunder/workspace-smundor/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/smundor/chilipeppr_smundor |
| Github URL            | http://github.com/Smunder/workspace-smundor |
| Test URL              | https://preview.c9users.io/smundor/chilipeppr_smundor/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/Smunder/workspace-smundor/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-smundor1"], // the id you gave your workspace
      function(myWorkspaceSmundor1) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / smundor1 just got loaded.", myWorkspaceSmundor1);
        myWorkspaceSmundor1.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-smundor1"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / smundor1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace smundor1."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/Smunder/workspace-smundor/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/smundor/chilipeppr_smundor"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/Smunder/workspace-smundor"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://chilipeppr_smundor-smundor.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
